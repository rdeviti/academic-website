...
Recently, I have been working on <a href="https://arxiv.org/abs/2208.03784">CoVault</a>, a secure selective analytics platform with applications in the interest of the public good. CoVault is <i>secure</i> under a strong threat model that leverages Multi-Party Computation (MPC) to place trust on a set of independent Trusted Execution Environments. CoVault is <i>selective</i> as it allows data sources to a priori restrict the use of their sensitive data to a pre-defined set of queries, run by specific analysts, and for a limited period. Currently, I am working on extending its use cases to support practical MPC-based ML training over very large sensitive datasets under the same threat model.
